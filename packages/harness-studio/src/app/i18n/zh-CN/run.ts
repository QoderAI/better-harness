...
export const run: typeof enRun = {
  ...
  acpStream: "ACP v1 · Harness 事件流",
  harnessStream: "Harness 运行事件流",
  cancelRun: "取消运行",
  savedRuns: "已保存运行",
  backToLive: "返回实时视图",
  ...
  placement: {
    ...
    boxDetail: "在一次性的 Linux 微虚拟机中运行 Agent。项目按原路径挂载，因此改动是真实的、文件引用也依然有效，而命令执行留在虚拟机内。Agent 在首次使用时安装，之后复用同一个 box。",
  },
  ...
  resizeTree: "调整执行树宽度",
  resizeInspector: "调整状态检查器宽度",
  composer: {
    title: "新建运行",
    agent: "Agent",
    qoderOption: "Qoder SDK · Harness 事件流",
