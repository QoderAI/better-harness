...
async function copyStudioAppStaticAssets({ development = false, revision } = {}) {
  ...
  await Promise.all([
    ...
    ...["tokens.css", "performance.css", "memory.css", "memory-review.css", "shell.css", "workbench.css", "customizations.css", "live-composer.css", "acp-session.css", "ai-elements.css"].map((file) =>
